...
const appCss = "/assets/styles-CQAE_d78.css";
...
function StoreProvider({ children }) {
  ...
  reactExports.useEffect(() => {
    try {
      ...
      const t = localStorage.getItem("ee_theme");
  ...
  reactExports.useEffect(() => {
    localStorage.setItem("ee_wish", JSON.stringify(wishlist));
  }, [wishlist]);
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Ctx.Provider, { value: { cart, wishlist, theme, addToCart, removeFromCart, setQty, toggleWishlist, isWished, toggleTheme, cartTotal, cartCount, clearCart }, children });
}
function useStore() {
...
function Header() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-50 border-b border-white/10 bg-black/70 glass shadow-2xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-7xl items-center justify-between px-6 py-4 backdrop-blur-xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Link,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl font-black tracking-[0.25em] text-white uppercase transition-all duration-300 group-hover:scale-105", children: "Aura Luxe" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs tracking-[0.45em] text-pink-400 uppercase font-semibold", children: "Beauty" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -inset-2 -z-10 rounded-full bg-pink-500/20 blur-2xl opacity-70 group-hover:opacity-100 transition-opacity duration-500" })
          ]
        }
      ),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-white", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setSearch((s) => !s), "aria-label": "Search", className: "rounded-full p-2 hover:bg-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "h-5 w-5" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/shop", className: "relative rounded-full p-2 hover:bg-white/10", "aria-label": "Wishlist", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "h-5 w-5" }),
          wishlist.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -right-1 -top-1 flex h-4 min-w-4 items-center justify-center rounded-full bg-primary px-1 text-[10px] font-medium text-primary-foreground", children: wishlist.length })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/cart", className: "relative rounded-full p-2 hover:bg-white/10", "aria-label": "Cart", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingBag, { className: "h-5 w-5" }),
          cartCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -right-1 -top-1 flex h-4 min-w-4 items-center justify-center rounded-full bg-primary px-1 text-[10px] font-medium text-primary-foreground", children: cartCount })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setOpen((o) => !o), className: "md:hidden rounded-full p-2 hover:bg-white/10", "aria-label": "Menu", children: open ? /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-5 w-5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Menu, { className: "h-5 w-5" }) })
      ] })
    ] }),
    search && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-white/10 bg-zinc-900/90 px-6 py-3 animate-fade-up", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-3xl items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "h-4 w-4 text-zinc-400" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          autoFocus: true,
    ...
    open && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-white/10 md:hidden bg-black/95 backdrop-blur-2xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2 px-6 py-4", children: [
      nav.map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Link,
        {
          to: n.to,
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "mt-32 border-t border-border/50 bg-gradient-to-b from-transparent to-secondary/40", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto grid max-w-7xl gap-10 px-6 py-16 md:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-display text-2xl", children: [
          "Aura Luxe",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient-gold", children: " Beauty" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm text-muted-foreground", children: "Maison of modern fragrance — crafted in Grasse, worn around the world." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-xs uppercase tracking-[0.25em] text-muted-foreground", children: "Shop" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-4 space-y-2 text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/shop", className: "hover:text-primary", children: "All Perfumes" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/shop", className: "hover:text-primary", children: "Bestsellers" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/shop", className: "hover:text-primary", children: "New Arrivals" }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-xs uppercase tracking-[0.25em] text-muted-foreground", children: "Maison" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-4 space-y-2 text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/about", className: "hover:text-primary", children: "Our Story" }) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/about", className: "hover:text-primary", children: "Sustainability" }) })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border/50 px-6 py-6 text-center text-xs text-muted-foreground", children: [
      "© ",
      (/* @__PURE__ */ new Date()).getFullYear(),
      " Éclat Essence. All rights reserved."
    ] })
  ] });
}
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center px-4 bg-black text-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-7xl", children: "404" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-zinc-400", children: "This page has drifted away like a forgotten scent." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "mt-6 inline-flex rounded-full bg-white px-6 py-3 text-xs uppercase tracking-[0.2em] text-black", children: "Return home" })
  ] }) });
}
function ErrorComponent({ error, reset }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center px-4 bg-black text-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-zinc-400", children: error.message }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
      router2.invalidate();
      reset();
    }, className: "mt-6 rounded-full bg-white px-6 py-3 text-xs uppercase tracking-[0.2em] text-black", children: "Try again" })
  ] }) });
}
...
function RootShell({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("html", { lang: "en", className: "dark", style: { colorScheme: "dark" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("body", { className: "bg-black text-white !bg-black", style: { backgroundColor: "#000000" }, children: [
      children,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Link,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs uppercase tracking-[0.2em]", children: [
          cartCount,
          " item",
          cartCount > 1 ? "s" : ""
        ] })
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsx(StoreProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 bg-black !bg-none", style: { backgroundColor: "#000000" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) }),
...
const $$splitComponentImporter$5 = () => import("./shop-w_du5XFD.js");
const Route$5 = createFileRoute("/shop")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Browse the full Éclat Essence perfume collection. Filter by floral, woody, oriental, citrus, and fresh fragrance families."
    }, {
      property: "og:title",
      content: "Shop Perfumes — Éclat Essence"
    }, {
      property: "og:description",
      content: "The full Éclat Essence collection."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./contact-D5BNee8t.js");
const Route$4 = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Get in touch with Éclat Essence for fragrance consultations, orders, and luxury perfume inquiries."
    }, {
      property: "og:title",
...
const $$splitComponentImporter$3 = () => import("./cart-Bi8KvCnn.js");
const Route$3 = createFileRoute("/cart")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Review your Éclat Essence bag and proceed to a secure, beautifully packaged checkout."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const aboutImg = "/assets/about-hero-BzE9w9bw.jpg";
const $$splitComponentImporter$2 = () => import("./about-313KgZKn.js");
const Route$2 = createFileRoute("/about")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Founded in Grasse, Éclat Essence reimagines luxury perfumery for the modern woman. Discover our maison, values, and craft."
    }, {
      property: "og:title",
      content: "Our Story — Éclat Essence"
    }, {
      property: "og:description",
      content: "A maison of modern luxury perfumery."
    }, {
      property: "og:image",
      content: aboutImg
    }]
...
const $$splitComponentImporter$1 = () => import("./index-BsdIdf9B.js");
const Route$1 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Luxury perfumes crafted in Grasse. Discover floral, woody, and oriental signature scents from Éclat Essence."
    }, {
      property: "og:title",
...
const fragranceTypes = ["Floral", "Woody", "Citrus", "Oriental", "Fresh"];
const $$splitComponentImporter = () => import("./product._id-Bw-VeuZt.js");
const Route2 = createFileRoute("/product/$id")({
  ...
  head: ({
    ...
    meta: [{
      ...
      property: "og:title",
      content: `${loaderData?.product?.name ?? ""} — Éclat Essence`
    }, {
      property: "og:description",
